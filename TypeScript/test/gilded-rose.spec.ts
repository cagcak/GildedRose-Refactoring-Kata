...
describe('Gilded Rose', () => {
  ...
  it('should decreases sell-in date but quality cannot be negative', () => {
    const currentGildedRose = new GildedRose([new Item(Goods.DEXTERITY_VEST, 0, 0)]);
  ...
  it('should decreases quality', () => {
    const currentGildedRose = new GildedRose([new Item(Goods.DEXTERITY_VEST, 10, 10)]);
    const items = currentGildedRose.updateQuality();
  ...
  it('should decreases quality faster after sell-in date expired', () => {
    const currentGildedRose = new GildedRose([new Item(Goods.DEXTERITY_VEST, 0, 10)]);
    const items = currentGildedRose.updateQuality();
  ...
  describe('Aged Brie', () => {
    it('should be ensure item "Aged Brie" increases in quality', () => {
      const currentGildedRose = new GildedRose([new Item(Goods.AGED_BRIE, 2, 2)]);
      const items = currentGildedRose.updateQuality();
    ...
    it('should doubles quality when item "Aged Brie" off', () => {
      const currentGildedRose = new GildedRose([new Item(Goods.AGED_BRIE, 0, 2)]);
      const items = currentGildedRose.updateQuality();
    ...
    it('should be ensure item "Aged Brie" cannot go over max value in quality', () => {
      const currentGildedRose = new GildedRose([new Item(Goods.AGED_BRIE, 2, 50)]);
      const items = currentGildedRose.updateQuality();
  ...
  describe('Sulfuras', () => {
    it('should be ensure sulfuras item never changes', () => {
      const currentGildedRose = new GildedRose([new Item(Goods.SULFURAS, 100, 100)]);
      const items = currentGildedRose.updateQuality();
  ...
  describe('Backstage Passes', () => {
    it('should increases by 1 outside 10 days for item "Backstage Passes" in quality', () => {
      const currentGildedRose = new GildedRose([new Item(Goods.BACKSTAGE_PASSES, 20, 2)]);
      const items = currentGildedRose.updateQuality();
    ...
    it('should increases by 2 inside 10 days for item "Backstage Passes" in quality', () => {
      const currentGildedRose = new GildedRose([new Item(Goods.BACKSTAGE_PASSES, 10, 2)]);
      const items = currentGildedRose.updateQuality();
    ...
    it('should increases by 3 inside 5 days for item "Backstage Passes" in quality', () => {
      const currentGildedRose = new GildedRose([new Item(Goods.BACKSTAGE_PASSES, 5, 2)]);
      const items = currentGildedRose.updateQuality();
    ...
    it('should sets to 0 when sell-in expires for item "Backstage Passes" in quality', () => {
      const currentGildedRose = new GildedRose([new Item(Goods.BACKSTAGE_PASSES, 0, 20)]);
      const items = currentGildedRose.updateQuality();
  ...
  describe('Conjured', () => {
    it('should decreases twice by the speed in quality', () => {
      const currentGildedRose = new GildedRose([new Item(Goods.CONJURED, 3, 6)]);
      const items = currentGildedRose.updateQuality();      
    ...
    it('should decreases twice by the speed in quality when sell-in expires', () => {
      const currentGildedRose = new GildedRose([new Item(Goods.CONJURED, 0, 6)]);
      const items = currentGildedRose.updateQuality();
